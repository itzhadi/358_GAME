...
export function TrickPlayScreen() {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
      ...
      <div className="flex-1 flex items-stretch justify-center min-h-0 overflow-hidden gap-2 sm:gap-4">
        {/* Left opponent */}
        ...
        {/* Center table */}
        <div className="flex flex-col items-center justify-center py-2 shrink">
          <div className="relative w-[55vw] max-w-[700px] h-[50vh] max-h-[380px] rounded-[2rem] border border-white/10 overflow-hidden"
            style={{
          ...
          >
            ...
            {/* Info badges */}
            <div className="absolute top-3 inset-x-4 flex justify-between items-center text-xs z-10">
              <div className="flex items-center gap-1.5 bg-black/40 backdrop-blur-sm rounded-full px-3 py-1 border border-white/10">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex gap-4 sm:gap-6">
                {currentTrick?.cardsPlayed.map((cp) => (
                  ...
                  >
                    <p className={cn(
                      'text-xs mb-1 font-bold truncate max-w-[80px] drop-shadow-[0_1px_3px_rgba(0,0,0,0.7)]',
                ...
                {(!currentTrick || currentTrick.cardsPlayed.length === 0) && (
                  <div className="text-white/50 text-sm font-medium animate-pulse-soft drop-shadow-[0_1px_4px_rgba(0,0,0,0.6)]">
                    ממתין לקלף ראשון...
                  </div>
                )}
              </div>
            ...
            <div className="absolute bottom-3 inset-x-4 flex justify-center">
              <div className={cn(
                'px-4 py-1.5 rounded-full text-xs font-medium border border-white/10',
