    ...
    return (
      <button
        ...
        className={cn(
          ...
          'active:scale-[0.97]',
          {
            'bg-gradient-to-l from-emerald-600 to-teal-600 text-white hover:from-emerald-500 hover:to-teal-500 shadow-lg shadow-emerald-900/20': variant === 'default',
            ...
            'bg-gradient-to-l from-emerald-600 to-teal-600 text-white glow-primary hover:from-emerald-500 hover:to-teal-500 shadow-lg shadow-emerald-900/25': variant === 'glow',
          },
          {
